...
quotes = [
    ...
    "Emacs is the most gummed-up piece of absolute s^!t there is!",
    "OS X file system is complete and utter crap.",
    "You're a complete idiot, and I'm not going to apply this patch because it's obviously broken and is a total piece of s^!t.",
    "Why did you do that horrible thing?",
    "When it works for you Angels sing and light suddenly fills the room.",
    "Goddamn idiot truckload of s^!t.",
